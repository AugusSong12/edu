...
<html>
<head>
<meta content="AugusSongIT教育系统" name="keywords" />
<meta content="AugusSongIT教育系统" name="description" />
...
<body>
	<form id="form1" >
		...
		<div class="footer">
			<footer>
				<p>  版权所有 @ 2018 AugusSongIT教育工作室 </p>
			</footer>
		</div>
	</form>
</body>
